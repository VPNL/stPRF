function [range, TolFun] = stSearchFit_range(params,model,data)
...
sigma_expandRange = expandRange*7;
gridSigmas = [0.015.*ones(sigma_expandRange,1); ...
              gridSigmas_unique; ...
              params.analysis.maxRF.*ones(sigma_expandRange,1)];
...
closestvalue    = closestvalue(1,:)+sigma_expandRange;

% set boundary
% more liberal upperboundary
range.upper(3,:) = gridSigmas(closestvalue+sigma_expandRange); 
range.lower(3,:) = gridSigmas(closestvalue-sigma_expandRange);
